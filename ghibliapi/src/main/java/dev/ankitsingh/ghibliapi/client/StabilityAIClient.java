package dev.ankitsingh.ghibliapi.client;

import dev.ankitsingh.ghibliapi.dto.TextToImageRequestDTO;
...
@FeignClient(
        ...
        configuration = dev.ankitsingh.ghibliapi.config.FeignConfig.class
)
